...
function AlbumInfo() {
    ...
    return(
        ...
        {album ? (
          ...
          <div key={album.id} className="flex items-center bg-white border border-gray-200 rounded-lg md:flex-row">
              <img className="w-full rounded-t-lg md:rounded-none md:rounded-s-lg" src={album.imageUrl} alt="Album Art"></img>
              <div className="flex flex-col justify-between w-full bg-brown-600 px-16 leading-normal">
